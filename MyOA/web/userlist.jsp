				...
				<div class="modal-body">
					<table class="table table-bordered table-striped" width="800px">
						...
						<tr>
							<td>初始密码</td>
							<td>
								<input class="form-control" type="password" name="password" placeholder="名称">
								<p id="p2"></p>
							</td>
						</tr>
						<tr>
							<td>电子邮箱</td>
							<td>
								<input class="form-control" name="email" placeholder="链接">
								<p id="p3"></p>
						    </td>
						</tr>
						<tr>
						    <td>级别</td>
						    <td>
						    	<select id="selRole" class="form-control" name="role" onchange="getNextManager(this.value)">
  ...
  <div class="modal-dialog" >
	...
	<script type="text/javascript">
		...
		function validateForm() {
			...
			var url = document.forms["permissionForm"]["password"].value;
			var percode = document.forms["permissionForm"]["email"].value;
			if (isNull(name)) {
