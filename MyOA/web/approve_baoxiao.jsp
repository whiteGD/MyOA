        ...
        <div class="panel-body">
            <form action="submitTask" method="post">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8">
							<input type="hidden" id="id" name="id" value="${baoxiaoBill.id}"/>
                            ...
                            <div class="form-group">
                               <c:forEach var="outcome" items="${outcomeList}">
                              		<input type="button" onclick="submitTask(this.value)" name="outcome" class="btn btn-primary" value="${outcome}"/>
                               </c:forEach>
                            </div>
                        </div>
                </div>
...
<script type="text/javascript">
    ...
    //         url:"submitTask",
    //         type: "post",
    //         data: $("#submitTask").serialize(),  //获取不到outcome的值
