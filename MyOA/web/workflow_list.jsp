                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="dep" items="${depList}">
	                    <tr>
	                        ...
	                        <td>
	                            <a onclick="delDeployment('${dep.id}')" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</a>
	                        </td>
	                    </tr>
					</c:forEach>
                    </tbody>
...
<script type="text/javascript">
    function delDeployment(depId) {
        var url = "delDeployment";
        var params = {
            deploymentId:depId,
        };
        $.getJSON(url,params,function(result){
            alert(result.delDeploymentMessage);
            location.reload();
        });
    }
</script>
